...
<div class="p-6 rounded-2xl bg-white dark:bg-slate-850 border border-slate-200 dark:border-slate-800 shadow-elevation-1 space-y-4">
    <h3 class="text-xs font-bold text-slate-900 dark:text-white uppercase tracking-wider">Aktivitas Terkini</h3>
        ...
        @forelse($activities as $act)
            <div class="flex items-center justify-between text-xs border-b border-slate-100 dark:border-slate-800/50 pb-2.5 last:border-0 last:pb-0">
                <div class="flex items-center space-x-2.5">
                    ...
                    <div>
                        <p class="font-semibold text-slate-800 dark:text-slate-200 capitalize">{{ str_replace('_', ' ', $act['action'] ?? 'aktivitas_sistem') }}</p>
                        <p class="text-[10px] text-slate-400">Aktivitas Terdaftar</p>
                    </div>
                </div>
